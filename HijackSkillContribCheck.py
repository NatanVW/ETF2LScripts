        ...
        if transfers is None:
            ...
            if len(playerIDList) == 0:
                ...
                for playerID in playerIDList:
                    ...
                    playerHL, player6s, HLMatchCount, SMatchCount, previousFMC= getPlayerSkillHS(playerID, teamDivName, fullCompList6v6, fullCompListHL, compList6v6, compListHL, previousFMC)
