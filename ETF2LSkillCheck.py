...
def playerSkill(compID, compList6v6, compListHL, playOff, tierName, playerHL, player6s, HLMatchCount, SMatchCount, playerID, week):
...
def higherSkillCheckETF2LFMC(player6s, playerHL, HLMatchCount, SMatchCount, playerID, higherSkilledPlayerIDList):
    if player6s['prem'] >= 1 or player6s['div1'] >= 1 or player6s['div2'] >= 1 or player6s['mid'] >= 1 or player6s['low'] >= 1 or player6s['open'] > 10:
        higherSkilledPlayerIDList.append(playerID)
        return higherSkilledPlayerIDList

    if playerHL['prem'] >= 1 or playerHL['div1'] >= 1 or playerHL['high'] >= 1 or playerHL['mid'] >= 1 or playerHL['low'] >= 1 or playerHL['open'] > 10:
        higherSkilledPlayerIDList.append(playerID)
        return higherSkilledPlayerIDList
